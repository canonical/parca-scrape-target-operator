The easiest way to report a security issue is through a [Github Private Security Report](https://github.com/canonical/parca-scrape-target-operator/security/advisories/new)
